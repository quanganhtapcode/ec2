# Quick Deployment Script (WITHOUT stock_data folder)
# Use this for daily code updates - much faster!
...
$VPSPath = "~/apps/ec2"
$GitRemote = "https://github.com/quanganhtapcode/ec2"
...
Write-Host "   QUICK DEPLOYMENT (Code Only)" -ForegroundColor Cyan
Write-Host "==================================================" -ForegroundColor Cyan
Write-Host ""
...
# STEP 1: DEPLOY TO VPS (Code files only)
Write-Host "==================================================" -ForegroundColor Cyan
Write-Host "STEP 1: DEPLOYING TO VPS (Code only)" -ForegroundColor Cyan
Write-Host "==================================================" -ForegroundColor Cyan
Write-Host ""
...
Write-Host "  - Code files deployed to VPS" -ForegroundColor Green
...
Write-Host ""
Write-Host "NOTE: stock_data folder was NOT uploaded (saves time)" -ForegroundColor Yellow
Write-Host "Use deploy-full.ps1 if you need to update stock data" -ForegroundColor Yellow
Write-Host ""
