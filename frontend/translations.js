...
const translations = {
    vi: {
        ...
        overviewPageTitle: "Thị Trường Chứng Khoán Việt Nam",
        searchTickers: "Tìm mã cổ phiếu...",
        valuation: "Định Giá",
        marketPE: "P/E Thị trường",
        vnIndex: "VN-Index",
        newsSection: "📰 Tin tức",
        updatedAgo: "Cập nhật vài phút trước",
        loadingNews: "Đang tải tin tức...",
        topMovers: "🔥 Top Biến Động",
        gainers: "📈 Tăng",
        losers: "📉 Giảm",
        foreignFlow: "💰 Khối Ngoại",
        foreignBuy: "NN Mua",
        foreignSell: "NN Bán",
        goldPrice: "🏆 Giá Vàng SJC",
        ...
        resultsDate: "Kết quả ngày:",
        noDataToday: "Chưa có dữ liệu hôm nay",
        loadingLottery: "Đang tải dữ liệu xổ số...",
        specialPrize: "G.ĐB",
        prize: "Giải"
    },
    en: {
        ...
        // Overview Page (index.html)
        overviewPageTitle: "Vietnam Stock Market Overview",
        searchTickers: "Search tickers...",
        valuation: "Valuation",
        marketPE: "Market P/E",
        vnIndex: "VN-Index",
        newsSection: "📰 News",
        updatedAgo: "Updated a few minutes ago",
        ...
        loadingLottery: "Loading lottery data...",
